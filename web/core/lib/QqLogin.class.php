...
class QqLogin{
    ...
    function __construct(){
        $res = &\core\SoDevel::getInstance();
        $this->conf = $res->config('qq');
        if($_SESSION["openid"]){  
            $this->keysArr = array(  
                "oauth_consumer_key" => $this->conf['appid'],  
    ...
    public function qq_callback(){
        ...
        $keysArr = array(  
            ...
            "client_id"     => $this->conf['appid'],  
            "redirect_uri"  => $this->conf['callback'],  
            "client_secret" => $this->conf['appkey'],  
            "code"          => $_GET['code']  
        );  
