            ...
            success:function(data)
            {
                ...
                switch(obj.info)
                {
                    case "用户名不能为空":
                        ...
                        break;
                    case "用户名含有非法字符":
                        falsePrompt("#checkname","用户名含有非法字符!");
                        break;
                    case "用户名已存在":
                        falsePrompt("#checkname","用户名已存在!");
                        break;
                    case "用户名格式不正确":
                        falsePrompt("#checkname","用户名格式不正确!");
                        break;
                    case "注册成功":
            ...
            success:function(data)
            {
                ...
                switch(obj.info)
                {
                    ...
                    case "电话号码格式不正确":
                        ...
                        break;
                    case "电话号码已经被注册":
                        falsePrompt("#checktel","电话号码已经被注册!","#btcode");
                        break;
                    case "成功":
    ...
    <form class="form-horizontal col-sm-6 col-sm-offset-3" role="form" action="?m=user&c=Register&f=add" method="post" >
       ...
       <div class="form-group">
        ...
        <div class=" col-sm-12 text-center">
            <button type="submit" class="btn btn-primary btn-lg" id="submit">注册</button>
