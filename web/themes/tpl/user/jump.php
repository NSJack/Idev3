...
<div id="js-alert-box" class="alert-box"> <svg class="alert-circle" width="234" height="234">
  ...
  <div class="alert-body">
    ...
    <div class="alert-concent">
      <p><img src="http://www.pintuer.com/images/ds-1.gif"></p>
      
    </div>
    <a id="js-alert-btn" class="alert-btn" href="http://ldev3.sodevel.com/?m=user&c=Login">立即前往登录</a> </div>
...
function alertSet(e) {
    ...
    setInterval(function() {
        if (0 == t){
			location.href="http://ldev3.sodevel.com/?m=user&c=Login";//#时间到后跳转地址
		}else {
            t -= 1,
            document.getElementById("js-sec-text").innerHTML = t;
